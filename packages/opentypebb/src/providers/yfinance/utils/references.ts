...
import { z } from 'zod'
import { EquityPerformanceDataSchema } from '../../../standard-models/equity-performance.js'
 ...
 */
export const INDICES: Record<string, { name: string; ticker: string }> = {
  ...
  cboe_bxrt: { name: 'CBOE Russell 2000 30-Delta Buy-Write Index', ticker: '^BXRT' },
  ...
  pt_bvlg: { name: 'Lisbon PSI All-Share Index GR (EUR)', ticker: '^BVLG' },
  es_ibex35: { name: 'IBEX 35 - Madrid CATS (EUR)', ticker: '^IBEX' },
  in_bse: { name: 'S&P Bombay SENSEX (INR)', ticker: '^BSESN' },
  in_bse500: { name: 'S&P BSE 500 Index (INR)', ticker: 'BSE-500.BO' },
  in_bse200: { name: 'S&P BSE 200 Index (INR)', ticker: 'BSE-200.BO' },
  in_bse100: { name: 'S&P BSE 100 Index (INR)', ticker: 'BSE-100.BO' },
  in_bse_mcap: { name: 'S&P Bombay Mid Cap Index (INR)', ticker: 'BSE-MIDCAP.BO' },
  in_bse_scap: { name: 'S&P Bombay Small Cap Index (INR)', ticker: 'BSE-SMLCAP.BO' },
  in_nse50: { name: 'NSE Nifty 50 Index (INR)', ticker: '^NSEI' },
  in_nse_mcap: { name: 'NSE Nifty 50 Mid Cap Index (INR)', ticker: '^NSEMDCP50' },
  in_nse_bank: { name: 'NSE Nifty Bank Industry Index (INR)', ticker: '^NSEBANK' },
  in_nse500: { name: 'NSE Nifty 500 Index (INR)', ticker: '^CRSLDX' },
  il_ta125: { name: 'Tel-Aviv 125 Index (ILS)', ticker: '^TA125.TA' },
  za_shariah: { name: 'Johannesburg Shariah All Share Index (ZAR)', ticker: '^J143.JO' },
  za_jo: { name: 'Johannesburg All Share Index (ZAR)', ticker: '^J203.JO' },
  za_jo_mcap: { name: 'Johannesburg Large and Mid Cap Index (ZAR)', ticker: '^J206.JO' },
  za_jo_altex: { name: 'Johannesburg Alt Exchange Index (ZAR)', ticker: '^J232.JO' },
  ...
  au_asx20: { name: 'S&P/ASX 20 Index (AUD)', ticker: '^ATLI' },
  au_asx50: { name: 'S&P/ASX 50 Index (AUD)', ticker: '^AFLI' },
  au_asx50_mid: { name: 'S&P/ASX Mid Cap 50 Index (AUD)', ticker: '^AXMD' },
  au_asx100: { name: 'S&P/ASX 100 Index (AUD)', ticker: '^ATOI' },
  au_asx200: { name: 'S&P/ASX 200 Index (AUD)', ticker: '^AXJO' },
  au_asx300: { name: 'S&P/ASX 300 Index (AUD)', ticker: '^AXKO' },
  au_energy: { name: 'S&P/ASX 200 Energy Sector Index (AUD)', ticker: '^AXEJ' },
  au_resources: { name: 'S&P/ASX 200 Resources Sector Index (AUD)', ticker: '^AXJR' },
  au_materials: { name: 'S&P/ASX 200 Materials Sector Index (AUD)', ticker: '^AXMJ' },
  au_mining: { name: 'S&P/ASX 300 Metals and Mining Sector Index (AUD)', ticker: '^AXMM' },
  au_industrials: { name: 'S&P/ASX 200 Industrials Sector Index (AUD)', ticker: '^AXNJ' },
  au_discretionary: { name: 'S&P/ASX 200 Consumer Discretionary Sector Index (AUD)', ticker: '^AXDJ' },
  au_staples: { name: 'S&P/ASX 200 Consumer Staples Sector Index (AUD)', ticker: '^AXSJ' },
  au_health: { name: 'S&P/ASX 200 Health Care Sector Index (AUD)', ticker: '^AXHJ' },
  ...
  jp_nkhd: { name: 'Nikkei Avg High Dividend Yield Index (JPY)', ticker: '^NKHD.OS' },
  jp_auto: { name: 'Nikkei 500 Auto & Auto Parts Index (JPY)', ticker: '^NG17.OS' },
  jp_fintech: { name: 'Global Fintech Japan Hedged Index (JPY)', ticker: '^FDSFTPRJPY' },
  ...
  jp_ndiv: { name: 'Nikkei Average Double Inverse Index (JPY)', ticker: '^NDIV.OS' },
  ...
  hk_titans30: { name: 'Dow Jones Hong Kong Titans 30 Index (HKD)', ticker: '^XLHK' },
  ...
  sp_energy_ig: { name: 'S&P 500 Energy (Industry Group) Index', ticker: '^SP500-1010' },
  sp_energy_equipment: { name: 'S&P 500 Energy Equipment & Services Industry Index', ticker: '^SP500-101010' },
  sp_energy_oil: { name: 'S&P 500 Oil, Gas & Consumable Fuels Industry Index', ticker: '^SP500-101020' },
  sp_materials_sector: { name: 'S&P 500 Materials Sector Index', ticker: '^SP500-15' },
  sp_materials_ig: { name: 'S&P 500 Materials (Industry Group) Index', ticker: '^SP500-1510' },
  sp_materials_construction: { name: 'S&P 500 Construction Materials Industry Index', ticker: '^SP500-151020' },
  sp_materials_metals: { name: 'S&P 500 Mining & Metals Industry Index', ticker: '^SP500-151040' },
  sp_industrials_sector: { name: 'S&P 500 Industrials Sector Index', ticker: '^SP500-20' },
  sp_industrials_goods_ig: { name: 'S&P 500 Capital Goods (Industry Group) Index', ticker: '^SP500-2010' },
  sp_industrials_aerospace: { name: 'S&P 500 Aerospace & Defense Industry Index', ticker: '^SP500-201010' },
  sp_industrials_building: { name: 'S&P 500 Building Products Industry Index', ticker: '^SP500-201020' },
  sp_industrials_construction: { name: 'S&P 500 Construction & Engineering Industry Index', ticker: '^SP500-201030' },
  sp_industrials_electrical: { name: 'S&P 500 Electrical Equipment Industry Index', ticker: '^SP500-201040' },
  sp_industrials_conglomerates: { name: 'S&P 500 Industrial Conglomerates Industry Index', ticker: '^SP500-201050' },
  sp_industrials_machinery: { name: 'S&P 500 Machinery Industry Index', ticker: '^SP500-201060' },
  sp_industrials_distributors: { name: 'S&P 500 Trading Companies & Distributors Industry Index', ticker: '^SP500-201070' },
  sp_industrials_services_ig: { name: 'S&P 500 Commercial & Professional Services (Industry Group) Index', ticker: '^SP500-2020' },
  sp_industrials_services_supplies: { name: 'S&P 500 Commercial Services & Supplies Industry Index', ticker: '^SP500-202010' },
  sp_industrials_transport_ig: { name: 'S&P 500 Transportation (Industry Group) Index', ticker: '^SP500-2030' },
  sp_industrials_transport_air: { name: 'S&P 500 Air Freight & Logistics Industry', ticker: '^SP500-203010' },
  sp_industrials_transport_airlines: { name: 'S&P 500 Airlines Industry Index', ticker: '^SP500-203020' },
  sp_industrials_transport_ground: { name: 'S&P 500 Road & Rail Industry Index', ticker: '^SP500-203040' },
  sp_discretionary_sector: { name: 'S&P 500 Consumer Discretionary Index', ticker: '^SP500-25' },
  sp_discretionary_autos_ig: { name: 'S&P 500 Automobiles and Components (Industry Group) Index', ticker: '^SP500-2510' },
  sp_discretionary_auto_components: { name: 'S&P 500 Auto Components Industry Index', ticker: '^SP500-251010' },
  sp_discretionary_autos: { name: 'S&P 500 Automobiles Industry Index', ticker: '^SP500-251020' },
  sp_discretionary_durables_ig: { name: 'S&P 500 Consumer Durables & Apparel (Industry Group) Index', ticker: '^SP500-2520' },
  sp_discretionary_durables_household: { name: 'S&P 500 Household Durables Industry Index', ticker: '^SP500-252010' },
  sp_discretionary_leisure: { name: 'S&P 500 Leisure Products Industry Index', ticker: '^SP500-252020' },
  sp_discretionary_textiles: { name: 'S&P 500 Textiles, Apparel & Luxury Goods Industry Index', ticker: '^SP500-252030' },
  sp_discretionary_services_consumer: { name: 'S&P 500 Consumer Services (Industry Group) Index', ticker: '^SP500-2530' },
  sp_staples_sector: { name: 'S&P 500 Consumer Staples Sector Index', ticker: '^SP500-30' },
  sp_staples_retail_ig: { name: 'S&P 500 Food & Staples Retailing (Industry Group) Index', ticker: '^SP500-3010' },
  sp_staples_food_ig: { name: 'S&P 500 Food Beverage & Tobacco (Industry Group) Index', ticker: '^SP500-3020' },
  sp_staples_beverages: { name: 'S&P 500 Beverages Industry Index', ticker: '^SP500-302010' },
  sp_staples_products_food: { name: 'S&P 500 Food Products Industry Index', ticker: '^SP500-302020' },
  sp_staples_tobacco: { name: 'S&P 500 Tobacco Industry Index', ticker: '^SP500-302030' },
  sp_staples_household_ig: { name: 'S&P 500 Household & Personal Products (Industry Group) Index', ticker: '^SP500-3030' },
  sp_staples_products_household: { name: 'S&P 500 Household Products Industry Index', ticker: '^SP500-303010' },
  sp_staples_products_personal: { name: 'S&P 500 Personal Products Industry Index', ticker: '^SP500-303020' },
  sp_health_sector: { name: 'S&P 500 Health Care Sector Index', ticker: '^SP500-35' },
  sp_health_equipment: { name: 'S&P 500 Health Care Equipment & Services (Industry Group) Index', ticker: '^SP500-3510' },
  sp_health_supplies: { name: 'S&P 500 Health Care Equipment & Supplies Industry Index', ticker: '^SP500-351010' },
  sp_health_providers: { name: 'S&P 500 Health Care Providers & Services Industry Index', ticker: '^SP500-351020' },
  sp_health_sciences: { name: 'S&P 500 Pharmaceuticals, Biotechnology & Life Sciences (Industry Group) Index', ticker: '^SP500-3520' },
  sp_health_biotech: { name: 'S&P 500 Biotechnology Industry Index', ticker: '^SP500-352010' },
  sp_health_pharma: { name: 'S&P 500 Pharmaceuticals Industry Index', ticker: '^SP500-352020' },
  sp_financials_sector: { name: 'S&P 500 Financials Sector Index', ticker: '^SP500-40' },
  sp_financials_diversified_ig: { name: 'S&P 500 Diversified Financials (Industry Group) Index', ticker: '^SP500-4020' },
  sp_financials_services: { name: 'S&P 500 Diversified Financial Services Industry Index', ticker: '^SP500-402010' },
  sp_financials_consumer: { name: 'S&P 500 Consumer Finance Industry Index', ticker: '^SP500-402020' },
  sp_financials_capital: { name: 'S&P 500 Capital Markets Industry Index', ticker: '^SP500-402030' },
  sp_it_sector: { name: 'S&P 500 IT Sector Index', ticker: '^SP500-45' },
  sp_it_saas_ig: { name: 'S&P 500 Software and Services (Industry Group) Index', ticker: '^SP500-4510' },
  sp_it_software: { name: 'S&P 500 Software Industry Index', ticker: '^SP500-451030' },
  sp_it_hardware: { name: 'S&P 500 Technology Hardware Equipment (Industry Group) Index', ticker: '^SP500-4520' },
  sp_it_semi: { name: 'S&P 500 Semiconductor & Semiconductor Equipment Industry', ticker: '^SP500-453010' },
  sp_communications_sector: { name: 'S&P 500 Communications Sector Index', ticker: '^SP500-50' },
  sp_communications_telecom: { name: 'S&P 500 Diversified Telecommunications Services Industry Index', ticker: '^SP500-501010' },
  sp_utilities_sector: { name: 'S&P 500 Utilities Sector Index', ticker: '^SP500-55' },
  sp_utilities_electricity: { name: 'S&P 500 Electric Utilities Index', ticker: '^SP500-551010' },
  sp_utilities_multis: { name: 'S&P 500 Multi-Utilities Industry Index', ticker: '^SP500-551030' },
  sp_re_sector: { name: 'S&P 500 Real Estate Sector Index', ticker: '^SP500-60' },
  sp_re_ig: { name: 'S&P 500 Real Estate (Industry Group) Index', ticker: '^SP500-6010' },
  ...
  ice_comm: { name: 'ICE FactSet Global NextGen Communications Index', ticker: '^ICEFSNC' },
  ...
  reit_wgresi: { name: 'Wilshire Global Real Estate Sector Index', ticker: '^WGRESI' },
  reit_wilreit: { name: 'Wilshire US REIT Index', ticker: '^WILREIT' },
  reit_wilresi: { name: 'Wilshire US Real Estate Security Index', ticker: '^WILRESI' },
...
export const YF_SCREENER_ALIAS_DICT: Record<string, string> = {
  name: 'shortName',
...
export const YFPredefinedScreenerDataSchema = EquityPerformanceDataSchema.extend({
  ...
  previous_close: z.number().nullable().default(null).describe('Previous close price.'),
  ma50: z.number().nullable().default(null).describe('50-day moving average.'),
  ma200: z.number().nullable().default(null).describe('200-day moving average.'),
  year_high: z.number().nullable().default(null).describe('52-week high.'),
  year_low: z.number().nullable().default(null).describe('52-week low.'),
  market_cap: z.number().nullable().default(null).describe('Market Cap.'),
  shares_outstanding: z.number().nullable().default(null).describe('Shares outstanding.'),
  ...
  eps_ttm: z.number().nullable().default(null).describe('Earnings per share over the trailing twelve months.'),
  eps_forward: z.number().nullable().default(null).describe('Forward earnings per share.'),
  pe_forward: z.number().nullable().default(null).describe('Forward price-to-earnings ratio.'),
  dividend_yield: z.number().nullable().default(null).describe('Trailing twelve month dividend yield.'),
  exchange: z.string().nullable().default(null).describe('Exchange where the stock is listed.'),
  exchange_timezone: z.string().nullable().default(null).describe('Timezone of the exchange.'),
  earnings_date: z.string().nullable().default(null).describe('Most recent earnings date.'),
  currency: z.string().nullable().default(null).describe('Currency of the price data.'),
}).passthrough()
